  ...
  module Arithmetic
    ...
    def ==(other_money)
      if other_money.respond_to?(:to_money)
        Money.deprecate "as of Money 6.1.0 you must `require 'money/core_extensions'` to compare Money to core classes." unless $MONEY_CORE_EXTENSIONS_LOADED_EXPLICITLY or other_money.is_a? Money
