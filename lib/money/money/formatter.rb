...
class Money
  class Formatter
    ...
    #
    # @example
    #   Money.new(0, "USD").format(display_free: true)     #=> "free"
    #   Money.new(0, "USD").format(display_free: "gratis") #=> "gratis"
    #   Money.new(0, "USD").format                         #=> "$0.00"
    #
    # @option rules [Boolean] :with_currency (false) Whether the currency name
    #  should be appended to the result string.
    #
    # @example
    #   Money.new(100, "CAD").format #=> "$1.00"
    #   Money.new(100, "CAD").format(with_currency: true) #=> "$1.00 CAD"
    #   Money.new(85, "USD").format(with_currency: true)  #=> "$0.85 USD"
    #
    ...
    #   Money.new(100.1, "USD").format(rounded_infinite_precision: true) #=> "$1"
    #   Money.new(100.9, "USD").format(rounded_infinite_precision: true) #=> "$1.01"
    #
    # @option rules [Boolean] :no_cents (false) Whether cents should be omitted.
    #
    # @example
    #   Money.new(100, "CAD").format(no_cents: true) #=> "$1"
    #   Money.new(599, "CAD").format(no_cents: true) #=> "$5"
    #
    # @option rules [Boolean] :no_cents_if_whole (false) Whether cents should be
    #  omitted if the cent value is zero
    #
    # @example
    #   Money.new(10000, "CAD").format(no_cents_if_whole: true) #=> "$100"
    #   Money.new(10034, "CAD").format(no_cents_if_whole: true) #=> "$100.34"
    #
    ...
    #
    # @example
    #   Money.new(570, "CAD").format(html_wrap: true, with_currency: true)
