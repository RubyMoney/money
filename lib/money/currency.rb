...
class Money
  ...
  class Currency
    ...
    TABLE = {
      ...
      :lbp => { :priority => 100, :iso_code => "LBP", :name => "Lebanese Pound",                            :symbol => "ل.ل",           :subunit => "Piastre",      :subunit_to_unit => 100,  :symbol_first => true, :html_entity => "&#x00A3;", :decimal_mark => ".", :thousands_separator => ","},
      ...
      :pln => { :priority => 100, :iso_code => "PLN", :name => "Polish Złoty",                              :symbol => "zł",            :subunit => "Grosz",         :subunit_to_unit => 100,  :symbol_first => false, :html_entity => "",         :decimal_mark => ".", :thousands_separator => ","},
