...
describe Money, "formatting" do
  ...
  INDIAN_BAR = '{ "priority": 1, "iso_code": "INDIAN_BAR", "iso_numeric": "840", "name": "Dollar with 4 decimal places", "symbol": "$", "subunit": "Cent", "subunit_to_unit": 10000, "symbol_first": true, "html_entity": "$", "decimal_mark": ".", "thousands_separator": ",", "indian_currency": true}'
  ...
  describe "#format" do
    ...
    describe ":indian_currency format delimiter" do
      ...
      specify "(:indian_currency => true) works as documented" do
        ...
        Money.new(1000000000, 'INDIAN_BAR').format(:indian_currency => true, :symbol => false).should == "1,00,000.0000"
